...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="#">Acer Tech</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item active">
            <button class="nav-link btn" type="button" data-toggle="modal" data-target="#modalCreateCompany">Job Posts</button>
            
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">Employment Activity</a>
        </li>
        <li class="nav-item">
